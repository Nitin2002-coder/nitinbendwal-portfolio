...
const skills = [
  ...
  { name: "JavaScript", level: 80, category: "programming", icon: "javascript" },
  ...
  { name: "Git/GitHub", level: 75, category: "tools", icon: "github" },
  { name: "HTML/CSS/Tailwind", level: 85, category: "frontend", icon: "html" },
];

const categories = [
  { id: "all", label: "All Skills", color: "bg-gradient-to-r from-purple-500 to-pink-500" },
  { id: "programming", label: "Programming", color: "bg-gradient-to-r from-indigo-500 to-violet-500" },
      ...
      >
        {duplicatedSkills.map((skill, index) => (
          <div key={`${skill.name}-${index}`} className="flex-shrink-0 flex flex-col items-center gap-2">
            <div className="w-14 h-14 rounded-full bg-card border-2 border-primary/50 flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
...
export const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="py-16 px-4 bg-gradient-to-br from-background via-secondary/5 to-background">
      <div className="container mx-auto max-w-[1280px]">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80">
            My Skills
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-base leading-relaxed">
            Technologies I use while building projects and improving my fundamentals
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
          {categories.map((category) => (
            <motion.button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium border border-transparent hover:shadow-lg ${
            ...
            <AnimatePresence mode="popLayout">
              {filteredSkills.map((skill) => (
                <motion.div
                  ...
                  className="bg-card p-5 rounded-2xl border border-border/30 hover:border-primary/50 transition-all duration-300 shadow-sm hover:shadow-lg group"
                >
