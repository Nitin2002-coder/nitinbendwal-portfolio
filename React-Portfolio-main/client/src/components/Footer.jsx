...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Github size={18} />, href: "https://github.com/Nitin2002-coder", label: "GitHub" },
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/nitin-bendwal-222382278", label: "LinkedIn" },
    { icon: <Mail size={18} />, href: "mailto:nitinbendwal030@gmail.com", label: "Email" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "nitinbendwal030@gmail.com", href: "mailto:nitinbendwal030@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9399365343", href: "tel:+919399365343" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Nitin Bendwal</h3>
          ...
          >
            <div>
              <p>© {currentYear} Nitin Bendwal. All rights reserved.</p>
            </div>
